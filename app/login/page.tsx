...
export default async function Login({
  ...
  //Changes Euricom to adapt Azure (Supabase login and signUp)
  ...
  if (session) {
    ...
    if (!profile) {
      ...
      const newProf = await createProfile(newProfile)
      ...
      const newHome = await createWorkspace(newHomeWorkspace)
